...
<head>
    ...
    <?php
    require_once APPROOT . '/views/inc/admin/head1.php';
...
<div class="page">
    <div class="page-main">
        <!-- HEADER -->
        <?php
        require_once APPROOT . '/views/inc/admin/admin_test_header.php';
                                ...
                                <div class="card overflow-hidden">
                                    <div class="card-body">
                                        <div class="">
                                            ...
                                            <h4 class="mb-1"><span class="number-font">&#36;<span class="counter">35,786</span></span></h4>
                                            <p class="mb-0 text-muted "><span class="text-danger fs-13 mr-2">(-0.05%)</span> than Last Year</p>
                                        </div>
                                    </div>
                                    <div class="chart-wrapper">
                                ...
                                <div class="card overflow-hidden">
                                    <div class="card-body">
                                        <div class="">
                                            ...
                                            <h4 class="mb-1"><span class="number-font"><span class="counter">45</span>&#37; </span></h4>
                                            <p class="mb-0 text-muted "><span class="text-success fs-13 mr-2">(+12%)</span> than Last Year</p>
                                        </div>
                                    </div>
                                    <div class="chart-wrapper">
        ...
        <div class="panel-body tabs-menu-body side-tab-body p-0 border-0 ">
            <div class="tab-content border-top">
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="list-group-item d-flex  align-items-center">
                        <div class="mr-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="../../assets/images/users/male/4.jpg" style="background: url(&quot;../../assets/images/users/male/2.jpg&quot;) center center;"></span>
                        </div>
                        <div class="">
                            <div class="font-weight-500">Isidro Heide</div>
                            <small class="text-muted">Web Designer
                    ...
                    <div class="list-group-item d-flex  align-items-center">
                        <div class="mr-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="../../assets/images/users/male/5.jpg" style="background: url(&quot;../../assets/images/users/male/2.jpg&quot;) center center;"></span>
                        </div>
                        <div class="">
                            <div class="font-weight-500">Isidro Heide</div>
                            <small class="text-muted">Web Designer
...
<!-- JQUERY SCRIPTS JS-->
<?php
require_once APPROOT . '/views/inc/admin/scripts1.php';
