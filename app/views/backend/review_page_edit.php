...
<div class="page">
    <div class="page-main">
        ...
        <div class="container  content-area">
            ...
            <form action="<?php echo URLROOT.'/'.$_SESSION["lang"].'/DemoTest/edit_review/'.$val['id'];?>" method="POST" name="edit_form">
                <div class="row">

                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label">customer name</label>
                            <input type="text" class="form-control" name="customer_name" placeholder="Enter customer name.." value="<?php echo $val['customer_name']?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label">writer name</label>
                            <input type="text" class="form-control" name="writer_name" placeholder="Writer name.." value="<?php echo $val['writer_name']?>" >
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="topic" placeholder="Topic.." value="<?php echo $val['topic']?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label">Comment</label>
                            <input type="text" class="form-control" name="comment" placeholder="comment.." value="<?php echo $val['comment']?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label">Rating</label>
                            <input type="number" class="form-control" name="rating" placeholder="rating.." value="<?php echo $val['rating']?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
