...
<header class="header">
    ...
    <div class="m-nav m-nav__main">
        <div class="m-nav__main-ul">
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon017ed5.png?v=qqqq" srcset="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon01.png?v=qqqq, assets/icon/mobile-menu__icon01@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-01"></picture>
                <a href="<?php echo URLROOT . "/ourTeam" ?>" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Our Team click">Our Team</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon027ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon02.png?v=qqqq, assets/icon/mobile-menu__icon02@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-02"></picture>
                <a href="order-an-essay.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header How to Order click">How to Order</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon037ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon03.png?v=qqqq, assets/icon/mobile-menu__icon03@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-03"></picture>
                <a href="#subnav-1" class="m-nav__parent ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Learn click">Writing services</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon047ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon04.png?v=qqqq, assets/icon/mobile-menu__icon04@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-04"></picture>
                <a href="custom-essay-writing-reviews.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Reviews click">Reviews</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon077ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon07.png?v=qqqq, assets/icon/mobile-menu__icon07@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-07"></picture>
                <a href="#subnav-2" class="m-nav__parent ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header About us click">About us</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon067ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon06.png?v=qqqq, assets/icon/mobile-menu__icon06@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-06"></picture>
                <a href="blog/index.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Blog click">Blog</a>
            </div>
            <div class="m-nav__divider"></div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon087ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon08.png?v=qqqq, assets/icon/mobile-menu__icon08@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-08"></picture>
                <a href="become-a-writer.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Become a writer click">Become a writer</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon107ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon10.png?v=qqqq, assets/icon/mobile-menu__icon10@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-10"></picture>
                <a href="https://essaypro.com/terms-and-conditions.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Terms and Conditions click">Terms and Conditions</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon107ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon10.png?v=qqqq, assets/icon/mobile-menu__icon10@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-10"></picture>
                <a href="https://essaypro.com/refund-policy.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Refund Policy click">Refund Policy</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon117ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon11.png?v=qqqq, assets/icon/mobile-menu__icon11@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-11"></picture>
                <a href="https://essaypro.com/privacy-policy.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Privacy Policy click">Privacy Policy</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/mobile-menu__icon097ed5.png?v=qqqq" srcset="assets/icon/mobile-menu__icon09.png?v=qqqq, assets/icon/mobile-menu__icon09@2x.png?v=qqqq 2x" alt="Icon" class="m-nav__img img-09"></picture>
                <a href="https://intercom.help/essaypro" rel="nofollow" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header FAQ click">FAQ</a>
            </div>
            <div class="m-nav__b">
                <picture><img src="<?php echo URLROOT . '/'; ?>assets/icon/telephone-book7ed5.svg?v=qqqq" alt="Icon" class="m-nav__img img-07">
                </picture>
                <a href="https://essaypro.com/contact-us.html" class="m-nav__a ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header Contact us click">Contact us</a>
            </div>
        </div>
    ...
    <div class="header__main">
        <div class="header__logo"><a class="logo ga-event" data-ga-category="home" data-ga-action="click" data-ga-label="home-header logo click" href="<?php echo URLROOT; ?>"><img src="<?php echo URLROOT . '/'; ?>assets/header/logo.svg" class="logo_img" alt="EssayPro"></a></div>
