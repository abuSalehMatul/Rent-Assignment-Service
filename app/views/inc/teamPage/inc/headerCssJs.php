...
<style>@-webkit-keyframes spinner {
    ...
    .p-2 #more_writers .button-outline__primary {
        min-width: 160px
    }
    ...
    .p-2__f-g .btn-primary.active, .p-2__f-g .btn-primary:focus, .p-2__f-g .btn-primary:hover {
        color: #848d99;
        background-color: #fff;
        -webkit-box-shadow: none;
        box-shadow: none
    ...
    .p-2__f-b:focus, .p-2__f-b:hover {
        outline: 0
    }

    .p-2__f-b.is--active, .p-2__f-b:hover {
        background-color: #eceff4;
        pointer-events: none
    }

    .p-2__f-b > .button-text {
        font-size: 14px;
        font-weight: 400;
        line-height: 16px
    }
    ...
    .c-22__li-p.is--active .c-22__a-t, .c-22__li-p:hover .c-22__a-t {
        background-color: #fff
    }

    .c-22__li-p .c-22__a-t {
        width: 100%;
        height: 18px;
        background-color: #eceff4
    }
    ...
    .c-22__li.is--active .c-22__a {
        background-color: #eceff4;
        border-color: #0082d5
    }

    .c-22__li.is--active .c-22__a .c-22__b {
        background-color: #fff
    }
...
<style>.p-2 .c-20, .p-3 .c-20 {
    ...
    .p-2 .c-20__ol, .p-3 .c-20__ol, .p-7 .c-20__ol {
        color: #afb9c8
    }
    ...
    .c-20__li:not(:first-child):before {
        content: '/\00a0';
        padding-left: 5px
    }

    .p-2 .c-20__li:not(:first-child):before, .p-3 .c-20__li:not(:first-child):before, .p-7 .c-20__li:not(:first-child):before {
        padding-left: 8px;
        padding-right: 3px;
        color: #afb9c8
    }
    ...
    @media (max-width: 767px) {
        .p-2 .c-20__li:not(:last-child):after, .p-3 .c-20__li:not(:last-child):after, .p-7 .c-20__li:not(:last-child):after {
            content: '/\00a0';
            padding-left: 8px;
            padding-right: 3px;
            color: #afb9c8
    ...
    .p-2 .c-20__li, .p-3 .c-20__li, .p-7 .c-20__li {
        margin: 5px 0
    }
    ...
    .p-2 .c-20__a, .p-3 .c-20__a, .p-7 .c-20__a {
        color: #8793a6
    }

    .p-2 .c-20__a:hover, .p-3 .c-20__a:hover, .p-7 .c-20__a:hover {
        color: #57657c
    }
...
<style>.rating-stars {
    ...
    .c-24__li-p .c-24__wr-av {
        background-color: #eceff4;
        border-color: #eceff4
    }

    .c-24__li-p .c-24__wr-n {
        width: 140px;
        height: 20px;
        background-color: #eceff4
    }

    .c-24__li-p .c-24__wr-d {
        width: 100%;
        max-width: 468px;
        height: 18px;
        background-color: #eceff4
    ...
    .c-24__li-p .c-24__st-li {
        width: 140px;
        height: 18px;
        background-color: #eceff4
    }

    .c-24__li-p .c-24__ac-b {
        width: 100px;
        height: 40px;
        background-color: #eceff4;
        -webkit-border-radius: 20px;
    ...
    .c-24__li .button-as-link.hire:hover {
        color: #0282d5;
        border: 1px solid #0282d5
    }
    ...
    .c-24__ps.ps-1 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_1__28x3222bf.svg?v1727f34e300)
    }

    .c-24__ps.ps-2 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_2__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-3 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_3__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-4 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_4__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-5 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_5__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-6 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_6__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-7 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_7__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-8 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_8__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-9 {
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_9__28x32c488.svg?v1727f34e304)
    }

    .c-24__ps.ps-10 {
        left: 5px;
        width: 32px;
        background-image: url(<?php echo URLROOT.'/';?>assets/writers/position_10__32x3222bf.svg?v1727f34e300)
    }
    ...
    @media (max-width: 767px) {
        ...
        .c-24__st-li:first-child {
            border-right: 1px solid #cbd4e0
        }

        .c-24__st-li:not(:last-child) {
            width: 50%
        }

        .c-24__st-li:last-child {
            width: 100%;
            border-top: 1px solid #cbd4e0
        }
    }
    ...
    @media (min-width: 768px) {
        .c-24__st-li.for__stars .c-24__st-l {
            display: none
        }
    }
    ...
    .c-24__ac .button-outline__primary {
        width: 110px
    }</style>
<style>.s-11 {
        position: relative;
