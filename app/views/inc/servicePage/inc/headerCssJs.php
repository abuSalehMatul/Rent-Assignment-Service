...
<style>.c-51 {
    ...
    @media (max-width: 767px) {
        .c-51.c-51-1 {
            background-image: -webkit-linear-gradient(136deg, #4c3768 0, #5f86c2 100%);
            background-image: -o-linear-gradient(136deg, #4c3768 0, #5f86c2 100%);
            background-image: linear-gradient(-46deg, #4c3768 0, #5f86c2 100%)
        }
    }
    ...
    @media (max-width: 767px) {
        .c-51.c-51-2 {
            background-image: -webkit-linear-gradient(136deg, #2a4c94 0, #00b8de 100%);
            background-image: -o-linear-gradient(136deg, #2a4c94 0, #00b8de 100%);
            background-image: linear-gradient(-46deg, #2a4c94 0, #00b8de 100%)
        }
    }

    .c-51.c-51-2 .bg__image--top {
        display: block;
        position: absolute;
        width: 100%;
        height: 450px;
    ...
    @media (max-width: 767px) {
        .c-51.c-51-3 {
            background-image: -webkit-linear-gradient(136deg, #274586 0, #699bd5 100%);
            background-image: -o-linear-gradient(136deg, #274586 0, #699bd5 100%);
            background-image: linear-gradient(-46deg, #274586 0, #699bd5 100%)
        }

        .c-51.c-51-3-aqua-blue {
            background-image: -webkit-linear-gradient(136deg, #3c5f81, #52a9a6 99%);
            background-image: -o-linear-gradient(136deg, #3c5f81, #52a9a6 99%);
            background-image: linear-gradient(-46deg, #3c5f81, #52a9a6 99%)
        }

        .c-51.c-51-3-green {
            background-image: -webkit-linear-gradient(136deg, #3d826c 0, #82c276 99%);
            background-image: -o-linear-gradient(136deg, #3d826c 0, #82c276 99%);
            background-image: linear-gradient(-46deg, #3d826c 0, #82c276 99%)
        }
    ...
    .c-51.c-51-4 {
        background-image: url(images/research-paper-bg57d3.jpg?v1727f34e480);
        background-repeat: no-repeat;
        -webkit-background-size: cover;
        background-size: cover;
        background-position: 57% 0
    ...
    @media (max-width: 767px) {
        .c-51.c-51-4 {
            background-image: -webkit-linear-gradient(136deg, #3c5f81 0, #52a9a6 99%);
            background-image: -o-linear-gradient(136deg, #3c5f81 0, #52a9a6 99%);
            background-image: linear-gradient(-46deg, #3c5f81 0, #52a9a6 99%)
        }
    }

    .c-51.c-51-5 {
        background-image: url(images/essay-help-bgefac.jpg?v1727f34e47c);
        background-repeat: no-repeat;
        -webkit-background-size: cover;
        background-size: cover;
        background-position: 57% 0;
    ...
    @media (min-width: 768px) {
        .c-51.c-51-5 .c-51__b:first-child {
            margin-right: 64px
        }
    }

    @media (min-width: 768px) and (max-width: 1023px) {
        .c-51.c-51-5 .c-51__b:last-child {
            margin-top: 32px
        }
    }
    ...
    @media (max-width: 767px) {
        ...
        .c-51.c-51-7-blue-purple {
            background-image: -webkit-linear-gradient(136deg, #274586 0, #699bd5 100%);
            background-image: -o-linear-gradient(136deg, #274586 0, #699bd5 100%);
            background-image: linear-gradient(-46deg, #274586 0, #699bd5 100%)
        }

        .c-51.c-51-7-aqua-blue {
            background-image: -webkit-linear-gradient(136deg, #3c5f81, #52a9a6 99%);
            background-image: -o-linear-gradient(136deg, #3c5f81, #52a9a6 99%);
            background-image: linear-gradient(-46deg, #3c5f81, #52a9a6 99%)
        }
    ...
    @media (min-width: 768px) and (max-width: 1023px) {
        ...
        .c-51.c-51-7 .c-51__w--2 {
            padding-top: 70px
        }
    }

    @media (min-width: 768px) and (max-width: 1023px) {
        .c-51.c-51-7 .c-51__b:first-child {
            margin-right: 0
        }
    }
    ...
    @media (min-width: 768px) and (max-width: 1023px) {
        .c-51.c-51-7 .c-51__b:last-child {
            margin-top: 32px
        }
    }
    ...
    .c-51.c-51-7 .h--lg.element_480px {
        max-width: 480px
    }
...
<style>.s-3--3 {
    ...
    .s-3--3__table-wrap .percent:before {
        content: "\A";
        border-style: solid;
    ...
    .s-3--3__table-wrap th:nth-child(2n) {
        background: #3b84e9
    }

    .s-3--3__table-wrap tr {
        font-weight: 300
    }

    .s-3--3__table-wrap tr:nth-child(2n) {
        background: #f8fafc
    }

    .s-3--3__table-wrap td {
        padding: 10px 51px
    }

    .s-3--3__table-wrap td span {
        display: inline-block
    }

    .s-3--3__table-wrap td span:first-child {
        margin-right: 11px;
